<?php if (!defined('THINK_PATH')) exit();?><html>
	...
	<head>
		...
		<style>
			...
			.list-block.media-list.person-card {
				background-image: url(/ffhysc/View/Admin/Public/img/adminBG.jpg);
	...
	<body>
				...
				<div class="page-settings">
						...
						<ul>
							<li>
								<div href="#" class="item-content">
									...
									<div class="item-media"><img id="userAvatar" src='/ffhysc/View/Admin/Public/img/adminIcon.jpg' width="80"></div>
									<div class="item-inner">
										<div class="item-title-row">
											<div class="item-title">管理员名称：</div>
										</div>
										<div class="item-subtitle"></div>
										<div class="item-text"><strong id="adminName">管理员</strong></div>
									</div>
								</div>
							</li>
						</ul>
					...
					<div class="content-block">
						<div onclick="$.linkToManage(0)" class="imgBox">
							<img src="/ffhysc/View/Admin/Public/img/manageIcon (7).png">
							<span>用户管理</span>
						</div>
						<div onclick="$.linkToManage(1)" class="imgBox">
							<img src="/ffhysc/View/Admin/Public/img/manageIcon (5).png">
							<span>商品管理</span>
						</div>
						<!--<div onclick="$.linkToManage(6)" class="imgBox">
							<img src="/ffhysc/View/Admin/Public/img/manageIcon (1).png">
							<span>订单管理</span>
							
						</div>
						<div onclick="$.linkToManage(3)" class="imgBox">
							<img src="/ffhysc/View/Admin/Public/img/manageIcon (4).png">
							<span>评论管理</span>
						</div>-->
						<!--<div onclick="$.linkToManage(3)" class="imgBox">
							<img src="/ffhysc/View/Admin/Public/img/i-form-name.png">
							<span>婚纱管理</span>
						</div>
		...
		<script src="/ffhysc/View/Admin/Public/js/homepage.js"></script>
		<script>
			//加载信息的方法
			...
			$.linkToManage = function(addressBiz) {
				...
				switch(addressBiz) {
					case 0:
						Url = "http://localhost/ffhysc/admin.php/index/userManage.html";
						break;
					case 1:
						Url = "http://localhost/ffhysc/admin.php/index/goodManage.html";
						break;
					case 2:
						Url = "";
						break;
					case 3:
						Url = "http://localhost/ffhysc/admin.php/index/photographerManage.html";
						break;
					case 4:
						Url = "";
						break;
					case 5:
						...
						break;
					case 6:
						Url = "http://localhost/ffhysc/admin.php/index/orderMange.html";
						break;
					case 7:
						Url = "";
						break;
