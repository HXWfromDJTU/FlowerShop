...
if (!defined('DOM_QUERY_DIR')) {
	define('DOM_QUERY_DIR', dirname(__FILE__) . DS);
}
if (!defined('DOM_QUERY')) {
	define('DOM_QUERY', DOM_QUERY_DIR . 'Query' . DS);
}
 ...
 */
require_once DOM_QUERY.'Css2Xpath.php';

/**
 * @see Zend_Dom_Query_Result
 */
require_once DOM_QUERY.'Result.php';

/** @see Zend_Xml_Security */
require_once DOM_QUERY_DIR.'Xml.php';

/** @see Zend_Xml_Exception */
require_once DOM_QUERY_DIR.'Xmlexception.php';
require_once DOM_QUERY_DIR.'Exception.php';
